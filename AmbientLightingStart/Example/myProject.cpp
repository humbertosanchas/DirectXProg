...
void MyProject::InitializeObjects()
{
	...
	//need to pass in proper shader pointer and size 
	primitive.InitializeInputLayout(D3DDevice, 0, 0);
...
{
	return; //NOTE REMOVE ONCE SHADER IS LOADED AND SET UP PROPERLY

	// calculate camera matrices
	ComputeViewProjection();

	// SETUP THE SHADER HERE 
